...
{literal}
	...
	$(function(){
		if(ismobile()){
			$('#realAccount').attr('action','http://m.'+domain+'/market_register.htm');
		}else{
...
{/literal}
	...
	<header>
		<div class="contain">
		<div class="head-img">
			<a href="http://www.totoav.com" target="_blank"><img src="http://www.5188yy.com/ym8/img/header_03.png" alt="最牛逼福利，只要注册存款就可享受" /></a>
		</div>
		<div class="head-img">
...
<div class="contain">	
	<div class="wapper clearfix">
		<div class="wap1-left">
			...
			<ul class="wap-ul">
				<li class="ico-list1">打开乐橙娱乐官网：<a href="http://md20lc8.com" target="_blank">md20lc8.com</a></li>
				<li class="ico-list2">点击注册乐橙账号，并存款</li>
				...
				<li class="ico-list4">注册存款教程——<a href="http://md20lc8.com/faqpage.htm"target="_blank">点击查看</a></li>
			</ul>-->
			<div class="main">
			<p class="wap-title ico-title1">注册存款<span>乐橙官网：{$domain}</span></p>
			<div class="main-contain">
				<form name="realAccount" id="realAccount" action="http://{$domain}/market_register.htm" target="_blank" method="post">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td>注册帐号：</td>
						<td><input type="text" size="1" maxlength="1" name="prefix" class="prefix" id="prefix" readonly="" value="k">

						<input type="text" name="loginname" id="loginname" class="prefix1" maxlength="9" size="15" onmouseover="value=value.replace(/[^a-zA-Z0-9]/g,'')" onKeyDown="LimitTextArea(this)" onKeyUp="LimitTextArea(this)" onkeypress="LimitTextArea(this)" placeholder="4-9位数字或小写英文字母组合" /></td>
					</tr>
					<tr>
						<td>设置密码：</td>
						<td><input type="password" maxlength="10" id="pwd" name="password"  required='required' class="text" size="20" placeholder="为8-10位字母+数字组合" /></td>
					</tr>
					<!--<tr>
						<td>手机号码：</td>
		...
		<div class="wap1-right">
			<p class="wap-title ico-title2">如何兑换</p>
				<ul class="wap-ul">
					<li class="ico-list1">联系客服青青QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin={$qq1}&site=qq&menu=yes" target="_blank"><img src="/img/button_111.gif"/></a>  青青二：<a href="http://wpa.qq.com/msgrd?v=3&uin={$qq2}&site=qq&menu=yes" target="_blank">{$qq2}</a></li>
					<li class="ico-list2">兑换格式：存款金额：xxxxx    娱乐城账号：xxxx    青青草账号：xxxx<br/>注意：客服青青审核通过后，开通青青草vip，发放裸聊账号以及淫妻杂志</li>
					<li class="ico-list3">乐橙存款会员，可以参加乐橙娱乐游戏，赢钱快速提款，输赢不会影响青青草VIP使用</li>
				</ul>
		</div>
	</div>
	<div class="wapper">
...
<p style="margin-left: 20px;display: block;padding: 16px 0 10px 30px;" class="ico-list4">青青草网站首存500 或 同一乐橙账号（1个月内）累计存款≥500，免费领取爱奇艺会员+同城约吧资源下载会员。</p>
	</div>
</div>
<div class="footer_vip mt30">
		...
		<p class="wap-title-while ico-title5">在线主持人列表</p>
			<div class="wap-zc">
				<ul class="ap-zc-ul clearfix">
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_1_03.jpg" alt="" /></div>
	...
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_2_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	...
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_3_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one-play" title="一对多忙碌中"></a></p>
	 <p class="null">&nbsp;</p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_4_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_5_03.jpg" alt="" /></div>
	...
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_6_03.jpg" alt="" /></div>
	...
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_7_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_8_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_9_03.jpg" alt="" /></div>
						<p><em class="ico-fu"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_10_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_11_03.jpg" alt="" /></div>
						<p><em class="ico-xian"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_12_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_13_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_14_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_15_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_16_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_17_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
					...
					<li class="zc-li">
						<div class="img"><img src="http://www.5188yy.com/ym8/img/girl_18_03.jpg" alt="" /></div>
						<p><em class="ico-p"></em>贝拉公主 <span class="right">免费视讯</span></p>
	<p>一对多5点 &nbsp;&nbsp;一对一20点</p>
	<p><a href="" class="one-one" title="一对多忙碌中"></a></p>
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
		...
		<div class="wapper mt30">
			<p class="wap-title-while ico-title6">乐橙游戏特色</p>
		...
		<div class="wapper mt30">
			<p class="wap-title-while ico-title7">乐橙实力展示</p>
			<div class="wap-seven mt30 clearfix">
			 	<div class="wap-seven-left" >
			 		<div class="slide-box clearfix" id="myFocus">
			 			<div class="pic">
			 			<ul>
			 				<li><a href="http://{$domain}" target="_blank"><img src="http://www.5188yy.com/lctt/cf1.png" alt="乐橙娱乐老虎机"/></a></li>
				 			<li><a href="http://{$domain}" target="_blank"><img src="http://www.5188yy.com/lctt/cf2.png" alt="乐橙娱乐老虎机"/></a></li>		 	
			 			</ul>
			 			</div>
			 		</div>
			 	</div>
			 	<div class="wap-seven-right">
			 		<div class="cont" id="marquee">
			 			 <ul>
			 			<li class="cont-word">
			 			<span class="name">caotit</span>:偶然在一个交友的qq群里面发现一个广告，点击观看是一个成人站点，我了解了一下，他们网站观是成人在线视频针对vip会员的，于是我充值了一百元到乐橙娱乐，客服很用心告诉我怎么操作vip，介绍游戏玩法，我试了一下老虎机，竟然赢了一百元，30分钟就到帐了，真不错
			 			</li>
			 			<li class="cont-word">
			 				...
			 				<li class="cont-word">
			 			<span class="name">jjbbao</span>:我是一名无业游民，靠着家里面的拆迁款过日子，于是养成赌的习惯，通过青青草在线视频，了解到乐橙娱乐，没想到网络真钱游戏可以做的和澳门赌场一样，持有菲律宾运营牌照，只要有时间，我边游戏，边看青青草电影
			 			</li>
...
<script src="http://www.5188yy.com/ym8/js/jquery.js"></script>
<script src="http://www.5188yy.com/ym8/js/myfocus-2.0.4.min.js"></script>
<script src="http://www.5188yy.com/ym8/js/datouwang.js"></script>
