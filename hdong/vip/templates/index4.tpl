...
<div class="contain">	
	<div class="wapper clearfix">
		<div class="wap1-left">
			...
			<ul class="wap-ul">
				<li class="ico-list1">打开和记娱乐官网：<a href="http://{$domain}" target="_blank">{$domain}</a></li>
				...
				<li class="ico-list4">注册存款教程——<a href="http://{$domain}/faqdeposit.htm"target="_blank">点击查看</a></li>
			</ul>
				<!--<div class="main">
				<p class="wap-title ico-title1">注册存款<span>和记官网：{$domain}</span></p>
