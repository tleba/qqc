...
<div class="contain">	
	<div class="wapper clearfix">
		<div class="wap1-left">
			...
			<ul class="wap-ul">
				<li class="ico-list1">打开利来娱乐官网：<a href="http://w66dc12.com" target="_blank">w66dc12.com</a></li>
				<li class="ico-list2">点击注册利来账号，并存款</li>
				...
				<li class="ico-list4">注册存款教程——<a href="http://www.w66dc12.com/faq.htm" target="_blank">点击查看</a></li>
			</ul>-->
			<div class="main">
			<p class="wap-title ico-title1">注册存款<span>利来官网：{$domain}</span></p>
			<div class="main-contain">
				<form name="realAccount" id="realAccount" action="http://{$domain}/MarketCreateRealAccount.htm" target="_blank" method="post">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td>注册帐号：</td>
						<td><input type="text" size="1" maxlength="1" name="prefix" class="prefix" id="prefix" readonly="" value="t">

						<input type="text" name="loginname" id="loginname" class="prefix1" maxlength="11" size="15" onmouseover="value=value.replace(/[^a-zA-Z0-9]/g,'')" onKeyDown="LimitTextArea(this)" onKeyUp="LimitTextArea(this)" onkeypress="LimitTextArea(this)" placeholder="4-9位数字或字母" /></td>
					</tr>
					<tr>
						<td>设置密码：</td>
						<td><input type="password" maxlength="10" id="pwd" name="pwd"  required='required' class="text" size="20" placeholder="8-16位数字和字母组合" /></td>
					</tr>
					<tr>
						<td>手机号码：</td>
		...
		<div class="wap1-right">
			<p class="wap-title ico-title2">如何兑换</p>
				<ul class="wap-ul">
					...
					<li class="ico-list3">利来存款会员，可以参加利来娱乐游戏，赢钱快速提款，输赢不会影响青青草VIP使用</li>
				</ul>
		</div>
	</div>
	<div class="wapper">
...
<p style="margin-left: 20px;display: block;padding: 16px 0 10px 30px;" class="ico-list4">青青草网站首存500 或 同一利来账号（1个月内）累计存款≥500，免费领取爱奇艺会员+同城约吧资源下载会员。</p>
	</div>
</div>
<div class="footer_vip mt30">
	...
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
		...
		<div class="wapper mt30">
			<p class="wap-title-while ico-title6">利来游戏特色</p>
		...
		<div class="wapper mt30">
			<p class="wap-title-while ico-title7">利来实力展示</p>
			<div class="wap-seven mt30 clearfix">
			 	<div class="wap-seven-left" >
			 		<div class="slide-box clearfix" id="myFocus">
			 			<div class="pic">
			 			<ul>
			 				<li><a href="http://{$domain}" target="_blank"><img src="http://a05image.cys1688.com/static/A05P/_default/__css/__images/one-fc/movie-box-img2.jpg" alt="勇者为王 终极格斗"/></a></li>
				 			<li><a href="http://{$domain}" target="_blank"><img src="http://a05image.cys1688.com/images/macauRacing/pickups_tab/banner10.jpg" alt="61届澳门格兰披治大赛车完美落幕"/></a></li>
			 			</ul>
			 			</div>
			 		</div>
			 	</div>
			 	<div class="wap-seven-right">
			 		<div class="cont" id="marquee">
			 			 <ul>
			 			<li class="cont-word">
			 			<span class="name">caotit</span>:偶然在一个交友的qq群里面发现一个广告，点击观看是一个成人站点，我了解了一下，他们网站观是成人在线视频针对vip会员的，于是我充值了一百元到利来娱乐，客服很用心告诉我怎么操作vip，介绍游戏玩法，我试了一下老虎机，竟然赢了一百元，30分钟就到帐了，真不错
			 			</li>
			 			<li class="cont-word">
			 				...
			 				<li class="cont-word">
			 			<span class="name">jjbbao</span>:我是一名无业游民，靠着家里面的拆迁款过日子，于是养成赌的习惯，通过青青草在线视频，了解到利来娱乐，没想到网络真钱游戏可以做的和澳门赌场一样，持有菲律宾运营牌照，只要有时间，我边游戏，边看青青草电影
			 			</li>
