...
//                $code[] = '<a href="#attach_favorite_video_' .$video['VID']. '" id="attach_media_video_' .$video['VID']. '"><img src="' .$config['BASE_URL']. '/media/videos/tmb/' .$video['VID']. '/1.jpg" alt="' .htmlspecialchars($video['title'], ENT_QUOTES, 'UTF-8'). '" class="img-responsive" /></a>';
