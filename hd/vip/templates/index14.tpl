...
<div class="contain">	
	<div class="wapper clearfix">
		<div class="wap1-left">
			...
			<ul class="wap-ul">
				<li class="ico-list1">打开盈佳国际官网：<a href="http://y777b.com?trackno=Aff_0755" target="_blank">y777b.com</a></li>
				...
				<li class="ico-list4">注册存款教程——<a href="http://y777b.com?trackno=Aff_0755"target="_blank">点击查看</a></li>
			</ul>-->
			<div class="main">
			<p class="wap-title ico-title1">注册存款<span>盈佳官网：{$domain}</span></p>
	...
	<div class="wapper">
		<div class="head-imgs mt30">
			<img src="/yamei/vip/img/yinjia.jpg" style="width:100%"alt="" />
        </div>
	</div>
</div>
