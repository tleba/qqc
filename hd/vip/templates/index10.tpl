...
<div class="contain">	
	<div class="wapper clearfix">
		<div class="wap1-left">
			...
			<ul class="wap-ul">
				<li class="ico-list1">打开赢佳娱乐官网：<a href="http://www.8lohu.net?trackno=Aff_0755" target="_blank">www.8lohu.net</a></li>
				...
				<li class="ico-list4">注册存款教程——<a href="http://www.8lohu.net?trackno=Aff_0755"target="_blank">点击查看</a></li>
			</ul>-->
			<div class="main">
			<p class="wap-title ico-title1">注册存款<span>赢佳官网：{$domain}</span></p>
		...
		<div class="wap1-right">
			<p class="wap-title ico-title2">如何兑换</p>
				<ul class="wap-ul">
					...
					<li class="ico-list3">赢佳存款会员，可以参加赢佳娱乐游戏，赢钱快速提款，输赢不会影响青青草VIP使用</li>
				</ul>
		</div>
	</div>
	<div class="wapper">
...
<div class="footer mt30">
	...
	<p><a href="" class="one-phone" title="电话试玩"></a></p>
		...
		<div class="wapper mt30">
			<p class="wap-title-while ico-title6">赢佳游戏特色</p>
			<ul class="wap-game clearfix">
				<li><a href="http://www.8lohu.net?trackno=Aff_0755" target="_blank"><img src="http://www.5188yy.com/ym/img/game_1.jpg" alt="" /></a></li>
				<li><a href="http://www.8lohu.net?trackno=Aff_0755" target="_blank"><img src="http://www.5188yy.com/ym/img/game_2.jpg" alt="" /></a></li>
				<li><a href="http://www.8lohu.net?trackno=Aff_0755" target="_blank"><img src="http://www.5188yy.com/ym/img/game_3.jpg" alt="" /></a></li>
				<li><a href="http://www.8lohu.net?trackno=Aff_0755" target="_blank"><img src="http://www.5188yy.com/ym/img/game_4.png" alt="" /></a></li>
			</ul>
		</div>
		
		<div class="wapper mt30">
			<p class="wap-title-while ico-title7">赢佳实力展示</p>
			<div class="wap-seven mt30 clearfix">
			 	<div class="wap-seven-left" >
			 		<div class="slide-box clearfix" id="myFocus">
			 			<div class="pic">
			 			<ul>
			 				<li><a href="http://www.8lohu.net" target="_blank"><img src="http://e02image.zytdled.com/images/racing/photo3.jpg" alt="第62届澳门格兰披治大赛车"/></a></li>
			 	...
			 	<div class="wap-seven-right">
			 		<div class="cont" id="marquee">
			 			 <ul>
			 			<li class="cont-word">
			 			<span class="name">caotit</span>:偶然在一个交友的qq群里面发现一个广告，点击观看是一个成人站点，我了解了一下，他们网站观是成人在线视频针对vip会员的，于是我充值了一百元到赢佳娱乐，客服很用心告诉我怎么操作vip，介绍游戏玩法，我试了一下老虎机，竟然赢了一百元，30分钟就到帐了，真不错
			 			</li>
			 			<li class="cont-word">
			 				...
			 				<li class="cont-word">
			 			<span class="name">jjbbao</span>:我是一名无业游民，靠着家里面的拆迁款过日子，于是养成赌的习惯，通过青青草在线视频，了解到赢佳娱乐，没想到网络真钱游戏可以做的和澳门赌场一样，持有菲律宾运营牌照，只要有时间，我边游戏，边看青青草电影
			 			</li>
