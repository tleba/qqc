     <div id="rightcontent">
        <div align="center"><b>Photo</b>: <a href="albums.php?m=viewphoto&PID={$PID}">{$PID}</a></div><br>
        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    <a href="albums.php?m=commentedit&PID={$PID}&COMID={$comments[i].CID}">Edit</a><br>
                    <a href="albums.php?m=comments&a=delete&PID={$PID}&COMID={$comments[i].CID}" onClick="javascript:return confirm('Are you sure you want to delete this comment?');">Delete</a><br>
                </td>
            </tr>
            {/section}
            {else}
