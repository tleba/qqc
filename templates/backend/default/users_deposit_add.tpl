     <div id="rightcontent">
        ...
        <legend>添加用户存款记录--{$username}({$user_range})</legend>
            ...
            <input type="checkbox" name="isfirstdeposit" value="1" style="box-sizing: border-box;position:relative;top:8px;margin-left:10px;"><br>
            
            <label for="" style="width:35%;">是否有红包抵扣？：</label>
            <input type="checkbox" name="ishongbao" value="1" style="box-sizing: border-box;position:relative;top:8px;margin-left:10px;"><br>
