     <div id="rightcontent">
        ...
        <div align="center">
        <div id="simpleForm">
        <form name="edit_user" method="POST" enctype="multipart/form-data" action="admin.php?m=edit">
        <fieldset>
        ...
        <input type="hidden" name="id" value="{$user.id}"/>
            ...
            <input type="text" name="name" value="{$user.name}" disabled  class="medium"><br>
        ...
        <div style="text-align: center;">
            <input type="submit" name="edit_admin" value="Edit Admin" class="button">
        </div>
        </form>
        </div>
        </div>
