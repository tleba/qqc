     <div id="rightcontent">
        ...
        <div id="searchForm">
            <form name="search_hd" method="POST" action="hd.php?m=newyear&type=1">
        ...
        <div id="right">
            ...
            <tr>
                ...
                <td align="center"><b>祝福信息</b></td>
                <td align="center"><b>ip</b></td>
                <td align="center"><b>是否审核</b></td>
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">{$rows[i].qq}</td>  
                <td align="center">{$rows[i].context}</td>
                <td align="center">{$rows[i].ip}</td>
                <td align="center">{if $rows[i].isshow == 1}是{else}否{/if}</td>
                <td align="center">{$rows[i].atime|date_format}</td>
                <td align="center">{if $rows[i].isshow == 0}<a href="hd.php?m=newyear&type=1&a=isshow&id={$rows[i].id}">审核</a>{else}已审核{/if}</td>
            </tr>
            {/section}
            {else}
            <tr>
