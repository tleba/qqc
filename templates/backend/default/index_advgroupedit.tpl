     <div id="rightcontent">
        ...
        <div align="center">
        <div id="simpleForm">
        <form name="edit_adv_group" method="POST" action="index.php?m=advgroupedit&AGID={$adv_group[0].advgrp_id}">
        <fieldset>
        <legend>Editing Group: {$adv_group[0].advgrp_name}</legend>
            <label for="adv_width">Width: </label>
            <input name="adv_width" type="text" value="{$adv_group[0].adv_width}"><br>
            <label for="adv_height">Height: </label>
            <input name="adv_height" type="text" value="{$adv_group[0].adv_height}"><br>
