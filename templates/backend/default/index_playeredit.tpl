     <div id="rightcontent">
        ...
        <div id="right">
        <div align="center">
        <h2>Editing: {$player.profile} player profile</h2>
        <div id="simpleForm">
        ...
        <legend>Global Settings</legend>
            ...
            <label for="buttons">Controls: </label>
            <select name="buttons">
        ...
        <legend>Logo Settings</legend>
            <label for="logo_url">Logo Filename:</label>
            <input name="logo_url" type="text" value="{$player.logo_url}"><small>You must upload the logo file in /media/player/logo</small><br>
            ...
            <input name="logo_alpha" type="text" value="{$player.logo_alpha}" maxlength="3" class="small"><small>%</small><br>
        </fieldset>
        <fieldset>
        <legend>Skin Settings</legend>
            ...
            <label for="related">Video Feed: </label>
            <select name="related">
            ...
            <label for="related_content">Video Feed Content: </label>
        ...
        <legend>Advertising Settings</legend>
            <label for="text_adv">Text Ads</label>
            ...
            <label for="video_adv">Media Ads: </label>
            ...
            <label for="video_adv_type">Media Advertising Type: </label>
            <select name="video_adv_type">
                <option value="global">Global (Random)</option>
                <option value="video">Video</option>
                <option value="channel">Channel</option>
            </select><br>
            <label for="video_adv_position">Media Ads Position: </label>
            <select name="video_adv_position">
                <option value="b"{if $player.video_adv_position == 'b'} selected{/if}>Beginning (Pre-roll)</option>
                <option value="e"{if $player.video_adv_position == 'e'} selected{/if}>End (Post-roll)</option>
