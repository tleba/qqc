     <div id="rightcontent">
        ...
        <tr>
            <td width="80%">
                ...
                <tr class="view">
                    <td align="top"><b>色币总数</b></td>
                    <td><b style="color:red;">{$user_sebi[0].sebi_total}</b></td>
                </tr>
                <tr class="view">
                    <td align="top"><b>消耗色币数</b></td>
                    <td><b style="color:red;">{$user_sebi[0].sebi_consume}</b></td>
                </tr>
                <tr class="view">
                    <td align="top"><b>剩余色币数</b></td>
                    <td><b style="color:red;">{$user_sebi[0].sebi_surplus}</b></td>
                </tr>
                <tr class="view">
