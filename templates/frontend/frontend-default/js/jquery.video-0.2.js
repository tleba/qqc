...
//			var embed_code = '<embed width="' + cw + '" height="' + ch + '" quality="high" wmode="transparent" name="main" id="main" allowfullscreen="true" allowscriptaccess="always" src="http://www.clipbit.com/media/player/player.swf?f=http://www.clipbit.com/media/player/config_embed.php?vkey=36" type="application/x-shockwave-flash" />';
