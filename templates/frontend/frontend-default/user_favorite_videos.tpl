				...
				<div class="panel-heading">
					...
					{if isset($smarty.session.uid) && $smarty.session.uid == $user.UID}
						<div class="pull-right">
							<a href="{$relative}/user/{$username}/favorite/videos?clear=yes" style="color:#fff;" title="{t c='favorite_videos.clear'}" onclick="javascript:return confirm('{t c='user.fav_videos_all'}');">{t c='global.clear_all'}</a>
						</div>
					{/if}					
