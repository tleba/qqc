			...
			<form class="form-horizontal" name="user_profile_form" id="user_profile_form" method="post" action="{$relative}/user/edit">
				<div class="col-md-6">
					<fieldset class="m-b-15">
						...
						<div class="form-group">
							<label for="profile_username" class="col-lg-4 control-label">{t c='global.username'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_email" class="col-lg-4 control-label">{t c='global.email'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group {if $err.password}has-error{/if}">
							<label for="profile_password" class="col-lg-4 control-label">{t c='global.password'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group {if $err.password}has-error{/if}">
							<label for="profile_password_confirm" class="col-lg-4 control-label">{t c='global.password_confirm'}</label>
							<div class="col-lg-8">
					...
					<fieldset class="m-b-15">
						...
						<div class="form-group">
							<label for="profile_fname" class="col-lg-4 control-label">{t c='user.first_name'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_lname" class="col-lg-4 control-label">{t c='user.last_name'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_gender" class="col-lg-4 control-label">{t c='global.gender'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group {if $err.bday}has-error{/if}">
							<label for="profile_bdate" class="col-lg-4 control-label">{t c='user.birthday'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_relation" class="col-lg-4 control-label">{t c='user.relationship'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_interested" class="col-lg-4 control-label">{t c='global.interested'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_website" class="col-lg-4 control-label">{t c='global.website'}</label>
							<div class="col-lg-8">
					...
					<fieldset class="m-b-15">
						...
						<div class="form-group">
							<label for="profile_hometown" class="col-lg-4 control-label">{t c='global.hometown'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_city" class="col-lg-4 control-label">{t c='global.city'}</label>
							<div class="col-lg-8">							
						...
						<div class="form-group">
							<label for="profile_country" class="col-lg-4 control-label">{t c='global.country'}</label>
							<div class="col-lg-8">
								<input name="country" type="text" class="form-control" value="{$user.country}" id="profile_country" />
							</div>
						</div>
						
						<div class="form-group">
							<label for="profile_occupation" class="col-lg-4 control-label">{t c='global.occupation'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_company" class="col-lg-4 control-label">{t c='global.company'}</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="profile_school" class="col-lg-4 control-label">{t c='global.school'}</label>
							<div class="col-lg-8">
				...
				<div class="col-md-6">
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="profile_about" class="col-lg-4 control-label">{t c='global.about_me'}</label>
							<div class="col-lg-8">
								<textarea name="aboutme" id="profile_about" class="form-control" rows="5">{$user.aboutme}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="profile_interests" class="col-lg-4 control-label">{t c='global.here_for'}</label>
							<div class="col-lg-8">
								<textarea name="interest_hobby" id="profile_interests" class="form-control" rows="5">{$user.interest_hobby}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="profile_movie" class="col-lg-4 control-label">{t c='user.favorite_sex'}</label>
							<div class="col-lg-8">
								<textarea name="fav_movie_show" id="profile_movie" class="form-control" rows="5">{$user.fav_movie_show}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="profile_music" class="col-lg-4 control-label">{t c='user.favorite_sex_partner'}</label>
							<div class="col-lg-8">
								<textarea name="fav_music" id="profile_music" class="form-control" rows="5">{$user.fav_music}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="profile_book" class="col-lg-4 control-label">{t c='user.my_erogenic_zones'}</label>
							<div class="col-lg-8">
								<textarea name="fav_book" id="profile_book" class="form-control" rows="5">{$user.fav_book}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="profile_turnon" class="col-lg-4 control-label">{t c='user.turn_on'}</label>
							<div class="col-lg-8">
								<textarea name="turnon" id="profile_turnon" class="form-control" rows="5">{$user.turnon}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="profile_turnoff" class="col-lg-4 control-label" rows="5">{t c='user.turn_off'}</label>
							<div class="col-lg-8">
