...
<div class="main">
    ...
    <div class="login">
        ...
        <div class="input-link margin-bottom-15 clearfix">
            <input type="text" class="float-left" value="您还没有登录，登录后可见>>">
            <a href="/">
                 <button data-clipboard-action="copy" data-clipboard-target="#link" class="block copy-link float-left margin-large-bottom-50" disabled="disabled">立即登录</button>
            </a>
        </div>
    </div>
</div>
