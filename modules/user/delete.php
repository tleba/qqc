...
if ( isset($_POST['delete_yes']) && isset($_POST['confirm_delete']) ) {
    ...
    $conn->execute($sql);
    $sql        = "UPDATE game SET UID = " .$anon_uid. " WHERE UID = " .$uid;
    $conn->execute($sql);
    ...
    $conn->execute($sql);
    $sql        = "DELETE FROM game_comments WHERE UID = " .$uid;
    $conn->execute($sql);	
    ...
    $conn->execute($sql);	
    $sql        = "DELETE FROM game_flags WHERE UID = " .$uid;
    $conn->execute($sql);	
    $sql        = "DELETE FROM game_rating_id WHERE UID = " .$uid;
    $conn->execute($sql);	
