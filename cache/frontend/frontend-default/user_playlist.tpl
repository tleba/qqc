				...
				<div class="panel-heading">
					...
					{if isset($smarty.session.uid) && $smarty.session.uid == $user.UID}
						<div class="pull-right">
							<a href="{$relative}/user/{$username}/playlist?clear=yes" style="color:#fff;" title="Clear Playlist" onclick="javascript:return confirm('{t c='user.playlist_clear'}');">{t c='global.clear_all'}</a>
						</div>
					{/if}					
