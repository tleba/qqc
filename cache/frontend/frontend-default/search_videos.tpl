<div class="container">
	...
	<div class="col-md-3 col-sm-4">
		...
		<script type="text/javascript" src="/ads/cat-search.js"></script>
		...
		<div class="well well-filters new_filters">
					<div class="pull-left">
						<h4>搜索含有<span class="hidden-xs hidden-sm"> “{$search_query|escape:'html'}” 的搜索结果</span>&nbsp;&nbsp;<i class="search_query_num">{$search_query_num}个视频</i></h4>
					</div>
					...
					<div class="well well-sm">
						<a href="{$relative}/video/{$videos[i].VID}/{$videos[i].title|clean}">
							<div class="thumb-overlay">
								...
								{if $videos[i].type == 'public'}<div class="label-private">{t c='global.PRIVATE'}</div>{/if}
