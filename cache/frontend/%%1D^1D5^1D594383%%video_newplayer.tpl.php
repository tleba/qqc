<?php /* Smarty version 2.6.20, created on 2018-04-06 15:22:50
         compiled from video_newplayer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'thumb_path', 'video_newplayer.tpl', 12, false),array('function', 't', 'video_newplayer.tpl', 16, false),)), $this); ?>
...
/media/player/js/swfobject.js"></script>
<div id="play_videos">
	...
	<?php if ($this->_tpl_vars['video']['iphone'] == 1): ?>
		<div id="mobile_player">
			<video controls poster="<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'thumb_path', 'vid' => $this->_tpl_vars['video']['VID'])), $this); ?>
/default.jpg" width="100%" height="100%"> <source type="video/mp4"></video>
		</div>
	<?php else: ?>
		<center>
			<div class="text-danger"><?php echo smarty_function_t(array('c' => 'video.not_available'), $this);?>
</div>
		</center>
	<?php endif; ?>
</div></div>
...
var token = '<?php echo $this->_tpl_vars['distributeds_token']; ?>
';
var vid = '<?php echo $this->_tpl_vars['vid']; ?>
';
var ads_view = parseInt('<?php echo $this->_tpl_vars['ads_view']; ?>
');
</script>
<?php echo '
...
'; ?>
	...
	f:'', a:'', s:'0', c:'0', x:'', i:'', d:'<?php echo $this->_tpl_vars['player_ads']['stop_ads']; ?>
', u:'<?php echo $this->_tpl_vars['player_ads']['stop_ads_uri']; ?>
', <?php if ($this->_tpl_vars['ads_view']): ?>l:'<?php echo $this->_tpl_vars['front_ads']['src']; ?>
',r:'<?php echo $this->_tpl_vars['front_ads']['href']; ?>
',
	t:'<?php echo $this->_tpl_vars['front_ads']['time']; ?>
',<?php endif; ?> y:'',e:'3',v:'80',p:'1', h:'4', q:'',m:'',o:'',w:'',g:'',j:'',k:'30|60',wh:'',lv:'0',loaded:'loadedHandler'
<?php echo '
};
