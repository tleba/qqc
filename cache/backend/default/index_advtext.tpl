     <div id="rightcontent">
        ...
        <div id="searchForm">
            <form name="search_videos" method="POST" action="ads.php?m=text">
            ...
            <tr>
                <td colspan="6" align="center" valign="bottom">
                    <input type="submit" name="search_text" value=" -- Search -- " class="button">
        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">{math equation="(( z * y ) / x )" x=$advs[i].views y=$advs[i].clicks z=100 format="%.2f"}%</td>
                <td align="center">{$advs[i].addtime|date_format}</td>
                <td align="center"><b>{if $advs[i].status == '1'}Active{else}Suspended{/if}</b></td>
                <td align="center">
                    <a href="index.php?m=advtextedit&AID={$advs[i].adv_id}">Edit</a><br>
					<a href="index.php?m=advtext&a=delete&AID={$advs[i].adv_id}" onClick="javascript:return confirm('Are you sure you want to delete this advertising text?');">Delete</a><br>
                    {if $advs[i].status == '1'}
					<a href="index.php?m=advtext&a=suspend&AID={$advs[i].adv_id}" onClick="javascript:return confirm('Are you sure you want to suspend this advertising text?');">Suspend</a>
                    {else}
					<a href="index.php?m=advtext&a=activate&AID={$advs[i].adv_id}" onClick="javascript:return confirm('Are you sure you want to activate this advertising text?');">Activate</a>
                    {/if}
                    <br>
                </td>
            </tr>
