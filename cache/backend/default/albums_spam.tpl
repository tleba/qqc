     <div id="rightcontent">
        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    <a href="albums.php?m=commentedit&PID={$comments[i].PID}&COMID={$comments[i].CID}">Edit</a><br>
                    <a href="albums.php?m=spam&a=delete&CID={$comments[i].CID}" onClick="javascript:return confirm('Are you sure you want to delete this comment?');">Delete</a><br>
                    <a href="albums.php?m=spam&a=unspam&SID={$comments[i].spam_id}" onClick="javascript:return confirm('Are you sure you want to unspam this comment?');">Unspam</a><br>
                </td>
            </tr>
            {/section}
            {else}
