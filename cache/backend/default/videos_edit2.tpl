     <div id="rightcontent">
        ...
        <legend>Video Information</legend>
            ...
            <select name="type">
            <option value="public"{if $video[0].type == 'public'} selected="selected"{/if}>任何用户可看</option>
            <option value="private"{if $video[0].type == 'private'} selected="selected"{/if}>付费用户可看</option>
            </select><br>
