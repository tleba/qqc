<div id="rightcontent">
        ...
        <legend>添加任务</legend>
            ...
            <input type="text" name="prize" class="large"><br>
            <label for="isshow">是否显示: </label>
            <input name="isshow" id="isshow" type="checkbox" style="margin-top:12px;" value="1"/><br>
            <label for="order" style="display:inline;float:none;margin:0 5px;">显示排序:</label>
            <input type="text" name="order" style="margin:12px;"/><br/>
        </fieldset>
        <div style="text-align: center;">
            <input type="submit" name="add_task" value="添加任务" class="button">
        </div>
        </form>
        </div>
        </div>
