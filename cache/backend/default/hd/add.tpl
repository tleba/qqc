...
{/literal}	
  <div id="rightcontent">
        ...
        <div align="center">
        <div id="simpleForm">
        <form name="add_hd" method="POST" enctype="multipart/form-data" action="hd.php?m=add">
        <fieldset>
        <legend>添加活动 / 活动</legend>
            <label for="title">标题: </label>
            <input type="text" name="title" class="large"><br>
            <label for="title">URL: </label>
            <input type="text" name="url" class="large"><font style="font-size:13px;margin-left:5px;color:red;">外部链接地址，不填写系统自动产生路径</font><br>
            ...
            <input type="checkbox" name="ispopular" value="1" style="margin:12px;"/><br>
            <label for="context">内容: </label>
            <textarea name="context" style="width:500px;height:600px;visibility:hidden;"></textarea><br>
           	<label for="title">keyword: </label>
            <input type="text" name="keyword" class="large"><font style="font-size:13px;margin-left:5px">多个用逗号(,)分隔，如AA,BB</font><br>
            ...
            <input id="sdatetimepicker" name="stime" type="text"><br/>
            <label for="category">结束时间: </label>
            <input id="edatetimepicker" name="etime" type="text"><br/>
             <label for="picture"></label>
            <input name="hidden" type="hidden">
        </fieldset>
        <div style="text-align: center;">
            <input type="submit" name="add_hd" value="添加活动" class="button">
        </div>
        </form>
        </div>
        </div>
