...
$categories     = get_categories($hide_categories);
...
$title_o        = NULL;
$title_p        = NULL;
$sql_add = $sql_delim.' channel NOT IN ('.implode(',', $hide_categories).')';
$sql_add_count = $sql_delim.' channel NOT IN ('.implode(',', $hide_categories).')';
$sql_delim = ' AND';
if ( $type != '' ) {
...
$sql_add       .= $sql_delim . " active = '1' AND hd='1'";
$sql_add_count .= $sql_delim . " active = '1' AND hd='1'";
...
$videos         = $rs->getrows();
$page_link      = $pagination->getPagination('hd');
...
if ($isMakeHtml == 1) {
	...
	$content .= $smarty->fetch('errors.tpl', null, null, false);
	$content .= $smarty->fetch('messages.tpl', null, null, false);
