...
$modules_allowed    = array('list','add','edit','del','cat_add','cat_edit','cat_del','cat_list','prizes','newyear','task','task_add','task_edit','task_receive','puzzle','puzzle_level','puzzle_record');
